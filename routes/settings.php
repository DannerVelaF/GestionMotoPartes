...
Route::middleware('auth')->group(function () {
    ...
    Route::get('configuracion/password', [PasswordController::class, 'edit'])->name('user-password.edit');

    Route::put('configuracion/password', [PasswordController::class, 'update'])
