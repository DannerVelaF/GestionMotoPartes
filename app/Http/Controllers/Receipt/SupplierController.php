...
class SupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            // Agregamos unique para email, permitiendo nulos si no es obligatorio
    ...
    public function update(Request $request, $id)
    {
        ...
        $rules = [
            ...
            'supplier_email' => [
                ...
                'email',
                'max:255',
                // Ignorar ID actual para Email (Para que no de error si no cambia su propio email)
